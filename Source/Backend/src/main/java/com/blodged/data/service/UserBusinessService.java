...
import com.blodged.data.repository.PostRepo;
import com.blodged.data.repository.UserRepo;
import com.blodged.model.db.PostModel;
import com.blodged.model.db.UserModel;
import com.blodged.model.db.metadata.UserMetadata;
/**
 ...
 */
    public List<UserModel> getAllUsers() {
        ...
        for (UserEntity ue : service.findAll()) {
            updated.add(new UserModel(ue.getPassword(), ue.getUsername(), ue.getEmail(), ue.getId(), ue.getBio(), ue.getCreatedDate(), ue.isPrivate(), ue.getRole()));
        }
        return updated;
    }
/**
 ...
 */
    public UserModel create(String username, String password, String email) {
        ...
        if (service.testExists(username, email).isEmpty()) {
            en = service.save(en);
            return new UserModel(en.getPassword(), en.getUsername(), en.getEmail(), en.getId(), en.getBio(), en.getCreatedDate(), en.isPrivate(), en.getRole());
        } else {
            return null;
        }
    }
 ...
 */
    public UserModel getFromId(long id) {
        ...
        if (en != null) return new UserModel(en.getPassword(), en.getUsername(), en.getEmail(), en.getId(), en.getBio(), en.getCreatedDate(), en.isPrivate(), en.getRole());
        else return null;
    }
    /**
    ...
    public UserModel getByEmail(String email) {
        ...
        if (u != null) {
            return new UserModel(u.getPassword(), u.getUsername(), u.getEmail(), u.getId(), u.getBio(), u.getCreatedDate(), u.isPrivate(), u.getRole());
        } else return null;
    }
    /**
 ...
 */
    ...
    public UserModel getFromUsername(String username) {
        ...
        return new UserModel(ue.getPassword(), ue.getUsername(), ue.getEmail(), ue.getId(), ue.getBio(), ue.getCreatedDate(), ue.isPrivate(), ue.getRole());
    }
    /**
